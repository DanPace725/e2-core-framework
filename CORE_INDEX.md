...
| E2_Essence_of_Existence_synthesized.ormd | 6 | 6 | 4 | 4 | 4 | no |
| Emergence_Engine_synthesized.ormd | 3 | 3 | 1 | 1 | 0 | no |
| Ethical Principles for Human-AI Interaction_summary.ormd | 1 | 1 | 1 | 1 | 0 | no |
| Exposure Protocol_summary.ormd | 1 | 1 | 1 | 1 | 0 | no |
| Family as a Relational Field_summary.ormd | 1 | 1 | 1 | 1 | 0 | no |
| From Essential Relationships to Ontological Transf_summary.ormd | 1 | 1 | 1 | 1 | 0 | no |
| Global_Closure_Operator_synthesized.ormd | 2 | 2 | 1 | 1 | 2 | no |
| hca-main Repo Summary.ormd | 1 | 1 | 0 | 0 | 0 | no |
| Human-AI Creative Collaboration Framework (HAIC)_summary.ormd | 1 | 1 | 1 | 1 | 0 | no |
| Implementations_summary.ormd | 1 | 1 | 1 | 1 | 0 | no |
| Initial Axioms_summary.ormd | 1 | 1 | 1 | 1 | 2 | no |
| Interlocked Stewardship V2_summary.ormd | 1 | 1 | 1 | 1 | 0 | no |
| Justice Across Scales Practical Applications_summary.ormd | 1 | 1 | 1 | 1 | 0 | no |
...
| Synthesized Core Document | Unresolved Summary Ref |
| --- | --- |
| none | - |

## Folder Contract

- `E2Core/Semantic Substrate/` and `E2Core/Context Layer/` are the active raw Core.
- `Synthesized Core/` is the active synthesis/index layer.
- `archive/` is provenance, not active Core, and is counted separately.
- `core_registry.json` records every active raw file and explicit composite/alias relation.
- `core_manifest.json` connects current state to synthesis and promotion provenance.
- `CORE_INDEX.md` is the human review surface generated by `phase1_core_reconcile.py`.
