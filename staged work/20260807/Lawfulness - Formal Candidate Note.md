...
Status: formal candidate note

Candidate date: 2026-08-10

Primary parents:

- `Condition as Typed Terrain - Candidate Bridge.md`
...
To avoid collision with legal and ethical uses of `lawful`, this candidate uses **predictive lawfulness** when the register is not already explicit. The retained handle does not imply juridical permission, moral rightness, or conformity with written law.
...
This candidate selects a **use-relative structural-stability definition** implemented through four gates rather than choosing stationarity, structural stability, or invariance as a universal essence. Those concepts remain domain-specific ways of satisfying the gates.

Before canonical promotion, the candidate should be tested in at least three materially different settings:
